...
<template>
    <GenericGroupView title="Frakcja" :backLink="$router.options.history.state.back || '/skaner/uczestnik'" mapDescription="Miejsce spotkań" messengerDescription="Grupa frakcji" 
    :ready="ready" 
    :loading="loading"
    :error="error"
    :group="data"
