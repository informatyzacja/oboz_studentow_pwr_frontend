                ...
                <div class="padding-main" v-if="apiDataStore.pointTypes.ready">
                    ...
                    <div
                        ...
                        <button class="button success" @click="addPoints"
                            v-if="points != 0 && selectedGroup && selectedGroup !== 'scan' && apiDataStore.pointTypes.withTypes(selectedGroupType, selectedPointType).points_min <= points && points <= apiDataStore.pointTypes.withTypes(selectedGroupType, selectedPointType).points_max && !loading && !success">Dodaj</button>
