...
<template>
  <IonTabBar class="navigation-bar">
    ...
    <div class="navigation-bar__content">
      ...
      <IonNavLink router-link="/home" router-direction="none">
        <div class="navigation_bar__item" :class="{ selected: $route.path == '/home' }">
          <img :src="SosIcon" alt="sos" />
          <p>Home</p>
        </div>
      </IonNavLink>

      <IonNavLink router-link="/tinder" router-direction="none">
        <div class="navigation_bar__item" :class="{ selected: $route.path == '/tinder' }">
          <img :src="SosIcon" alt="sos" />
          <p>Tinder</p>
        </div>
      </IonNavLink>
 ...
 -->
      ...
      <IonNavLink router-link="/tinder/profil" router-direction="none">
